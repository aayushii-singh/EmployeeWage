...
try {
    let employeePayrollData = new EmployeePayrollData(1, "Mark", 30000, "M", new Date("2023-06-01"));
...
try {
    ...
    let employee2 = new EmployeePayrollData(2, "Alice", 40000, "X", new Date("2022-01-15"));
...
try {
    ...
    let employee3 = new EmployeePayrollData(3, "John", 50000, "M", new Date("2030-01-01"));
